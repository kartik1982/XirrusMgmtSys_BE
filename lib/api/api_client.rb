...
# require 'api/resource_path/arrays-b'
# require 'api/resource_path/profiles'
# require 'api/resource_path/profiles-b'
...
# require 'api/resource_path/aosversions.rb'
# require 'api/resource_path/tenantcircles.rb'
