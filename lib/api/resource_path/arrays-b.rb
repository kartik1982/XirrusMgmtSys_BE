module API
  class ApiClient
    ...
    #
    # @param args [Hash]
    # @custom args :macAddress path string *required
    ...
    #
    # @param args [Hash]
    # @custom args :serialNumber path string *required
    # @return [XMS::NG::ApiClient::Response]
    ...
    # @custom args :sortBy query string  allowed - ["baseMacAddress", "actualIpAddress", "serialNumber", "activationStatus", "recentActivation", "hostName", "location", "onlineStatus", "actualNetmask", "actualGateway", "licenseKey", "licensedAosVersion", "arrayModel", "manufacturer", "baseIapMacAddress", "profileName", "clients", "rxBytes", "txBytes", "penaltyType", "reportedAosVersion"]
    ...
    # @return [XMS::NG::ApiClient::Response]
    def add_arrays(args = {})
      post("/arrays.json/backoffice", args)
    end
    ...
    # @custom args :start query int
    # @custom args :count query int
    # @custom args :sortBy query string  allowed - ["globalSerialNumber", "globalMacAddress", "globalArrayId", "globalActivationStatus", "penaltyType", "globalLicenseKey"]
    # @custom args :sortOrder query string  allowed - ["asc", "desc"]
    # @return [XMS::NG::ApiClient::Response]
    ...
    def delete_array(args = {})
      delete("/arrays.json/backoffice/#{args[:arrayId]}", args)
    end

    def delete_array_global(args = {})
      delete("/arrays.json/backoffice/#{args[:arrayId]}", args)
    end
    ...
    # @custom args :start query int
    # @custom args :count query int
    # @custom args :sortBy query string  allowed - ["baseMacAddress", "serialNumber"]
    # @custom args :sortOrder query string  allowed - ["asc", "desc"]
    # @return [XMS::NG::ApiClient::Response]
    ...
    #
    # @param args [Hash]
    # @custom args :NONAME body OptimizationActionDto *required
    # @return [XMS::NG::ApiClient::Response]
    ...
    #
    # @param args [Hash]
    # @custom args :NONAME body List[string]
    # @return [XMS::NG::ApiClient::Response]
    ...
    #
    # @param args [Hash]
    # @custom args :tenantId query string
    # @custom args :sortBy query string  allowed - ["tenantId", "serialNumber", "penaltyType"]
    # @custom args :sortOrder query string  allowed - ["asc", "desc"]
    # @return [XMS::NG::ApiClient::Response]
